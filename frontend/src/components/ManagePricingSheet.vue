                        ...
                        <div class="pt-3 shrink-0">
                            ...
                            <div class="flex items-center justify-between px-5 pb-4 border-b border-gray-100">
                                <div>
                                    ...
                                    <h3 class="text-base font-extrabold text-black">Dynamic Pricing</h3>
                                </div>
                        ...
                        <div class="flex-1 overflow-y-auto px-5 py-5 space-y-5">
                            ...
                            <div v-else-if="rules.length" class="space-y-2">
                                <div v-for="rule in rules" :key="rule.id"
                                    class="flex items-start gap-3 bg-white rounded-xl px-4 py-3">
                            ...
                            <p v-else class="text-center text-gray-400 text-sm py-4">No pricing rules — base rate applies</p>
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-2">
                                        <button v-for="dt in DAY_TYPES" :key="dt.value" @click="newDayType = dt.value"
                                            ...
                                            :class="newDayType === dt.value ? 'bg-black text-white' : 'bg-white ring-1 ring-slate-200 text-gray-500'">
                                            {{ dt.label }}
                                        </button>
                                    </div>
                                </div>
